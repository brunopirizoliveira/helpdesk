/*	Valida a inserção de chamado por parte do técnico	*/

$(document).ready(function(){

	$("#novoChamadoTech").validate({
		rules: {
			novoLogin: "required",
			novoTipo: {
				required: true,
	...
	$("#novoEnviar").on('click',function(e){
		e.preventDefault();
		$("#novoChamadoTech").submit();
		if($("#novoChamadoTech").validate().errorList.length == 0){
